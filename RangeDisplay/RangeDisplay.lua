...
local DefaultFontName = "Arial Narrow"
    ...
    profile = {
        ...
        units = {
            ["**"] = {
                ...
                crSection = {
                    enabled = true,
                    color = makeColor(0.9, 0, 0),
                    range = 5,
                    warnSoundName = DefaultSoundNames["crSection"],
                },
            },
            ["playertarget"] = {
				relFrame = "TargetFrame",
            },
            ["focus"] = {
                relFrame = "FocusFrame",
            },
...
local function applySettings(ud, whatChanged)
    if ud.db.enabled then
        ...
        ud.mainFrame:SetPoint(ud.db.point, ud.db.relFrame, ud.db.relPoint, ud.db.x, ud.db.y)
